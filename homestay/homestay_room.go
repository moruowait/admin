...
func GetHomestayRoomTable(ctx *context.Context) table.Table {
	...
	info.AddField("Monthly_rent", "monthly_rent", db.Float)
	info.AddField("Monthly_manage_fee", "monthly_manage_fee", db.Float)
	...
	formList.AddField("Monthly_rent", "monthly_rent", db.Float, form.Currency)
	formList.AddField("Monthly_manage_fee", "monthly_manage_fee", db.Float, form.Currency)
